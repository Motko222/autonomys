...
plotted0=$(cat $flog | grep --line-buffered --text "Plotting sector " | grep --line-buffered --text "farm_index=0" | tail -1 | awk -F "Plotting sector " '{print $2}' | awk '{print $1}' | sed 's/(\|)//g')
plotted1=$(cat $flog | grep --line-buffered --text "Plotting sector " | grep --line-buffered --text "farm_index=1" | tail -1 | awk -F "Plotting sector " '{print $2}' | awk '{print $1}' | sed 's/(\|)//g')
